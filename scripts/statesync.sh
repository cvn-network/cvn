...
# Initialize chain.
cvnd init test --chain-id cvn_8007-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.cvnd/config/

wget -O ~/.cvnd/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
...
export CVND_STATESYNC_RPC_SERVERS="https://evmos-rpc.polkachu.com:443,https://rpc-evmos-ia.notional.ventures:443"
