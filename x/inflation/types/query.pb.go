...
// QueryInflationRequest is the request type for the Query/InflationRate RPC
// method.
...
// QueryInflationResponse is the response type for the Query/InflationRate
// RPC method.
type QueryInflationResponse struct {
	// inflation by which the total supply increases within one period
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_91b9f1b5d47c7fd7, []int{12}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_91b9f1b5d47c7fd7, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*QueryInflationRequest)(nil), "evmos.inflation.v1.QueryInflationRequest")
	proto.RegisterType((*QueryInflationResponse)(nil), "evmos.inflation.v1.QueryInflationResponse")
...
var fileDescriptor_91b9f1b5d47c7fd7 = []byte{
	...
	,
}
...
func (c *queryClient) Inflation(ctx context.Context, in *QueryInflationRequest, opts ...grpc.CallOption) (*QueryInflationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/evmos.inflation.v1.Query/Inflation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Inflation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evmos.inflation.v1.Query/Inflation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
