...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "cvnd", "Home directory of the node's daemon configuration")
...
func initTestnetFiles(
	...
	if args.chainID == "" {
		args.chainID = fmt.Sprintf("cvn_%d-1", tmrand.Int63n(9999999999999)+1)
	}
