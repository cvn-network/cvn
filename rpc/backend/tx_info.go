...
func (b *Backend) GetGasUsed(res *evmostypes.TxResult, price *big.Int, gas uint64) uint64 {
...
func (b *Backend) GetTxByEthHash(hash common.Hash) (*evmostypes.TxResult, error) {
	if b.indexer != nil {
...
func (b *Backend) GetTxByTxIndex(height int64, index uint) (*evmostypes.TxResult, error) {
...
func (b *Backend) queryTendermintTxIndexer(query string, txGetter func(*rpctypes.ParsedTxs) *rpctypes.ParsedTx) (*evmostypes.TxResult, error) {
