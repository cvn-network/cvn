...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "cvn_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "CVN_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Cvn_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "cvn_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "cvn_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "cvn_cvn_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "cvn_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "cvn_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
